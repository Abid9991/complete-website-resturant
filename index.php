...
<?php include "header.php"; ?>	
	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-left">
				<img src="images/2678.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> GoodBites Restaurant</strong></h1>
							<p class="m-b-40">Have It Your Way,   <br> 
							World's Greatest Hamburgers</p>
							<p><a href="menu.php" class="btn btn-lg btn-circle btn-outline-new-white" href="#">Food Menu</a></p>
						</div>
					</div>
				</div>
			</li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">GoodBites is serving a Authentic GoodBites Food.And Restaurant's 
<br> 
							Ambience is a very good with well trained staff with open kitchen concept...</p>
							<p><a  href="contact.php" class="btn btn-lg btn-circle btn-outline-new-white" href="#">Contact Us</a></p>
						</div>
					</div>
				</div>
			</li>
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yumifood with GoodBites</strong></h1>
							<p class="m-b-40">Deliciousness jumping into the mouth<br> 
							We know our food..</p>
							<p><a href="Review.php" class="btn btn-lg btn-circle btn-outline-new-white" href="#">Review</a></p>
						</div>
					</div>
				</div>
			</li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>GoodBites Restaurant</span></h1>
						<h4>Little Story</h4>
						<p>Restaurants in FatehChwok, FatehChwok Restaurants, Hyderabad restaurants, Best Hyderabad restaurants, FatehChwok restaurants, Hyderabd Restaurants in Fatehchowk, Bollyvuard near me, Hyderabad Restaurants in Fatehchowk, 
FastFood Restaurants in Bopal, 
 </p>
						<p>Quick Bites in Hyderabad, Quick Bites near me, Quick Bites in Fatehchowk, Quick Bites in FatehChwok, in Hyderabad, near me, in Fatehchowk,  in Hyderabad, near me, in Bollyvuard, in Hyderabd, New Year Parties in Hyderabad, Eid' Special in Hyderabad,</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">GoodBites</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for GoodBites Restaurent Listed Here </p>
					</div>
				</div>
			</div>
